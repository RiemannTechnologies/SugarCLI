...
TEST(nested_comp_test, FirstBranchBasicParse) {
    ...
    auto height = static_cast<riemann::configuration_item<double> *>(component.children["first"]->items["height"]);
    auto is_married = static_cast<riemann::configuration_item<bool> *>(component.children["first"]->items["is_married"]);
...
TEST(nested_comp_test, SecondBranchBasicParse) {
    ...
    auto name = static_cast<riemann::configuration_item<std::string> *>(component.children["second"]->items["name"]);
    auto age = static_cast<riemann::configuration_item<int> *>(component.children["second"]->items["age"]);
